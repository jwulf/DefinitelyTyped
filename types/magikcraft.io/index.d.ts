...
declare namespace magikcraft {
    namespace io {
         ...
         */
        function type(classname: string): JavaType;
         ...
         *
         */
        function getPlugin(): BukkitPlugin;
         ...
         * ```
         */
        function aspecto(): BukkitLocation;
         ...
         * ```
         */
        function caldarium(ingredientsList: string[]): string;
         ...
         * ```
         */
        function stella(location: BukkitLocation): void;
         ...
         * ```
         */
        function declaro(item: string): void;
         ...
         * ```
         */
        function shakti(location?: BukkitLocation): void;
...
declare namespace magikcraft {
    namespace io {
         ...
         * ```
         */
        function dixit(message: string, playername?: string): void;
    }
}
declare namespace magikcraft {
    namespace io {
         ...
         * ```
         */
        function doNTimes(task: () => void | any, times: number, delay: number, callback?: () => void | any): void;
    }
}
declare namespace magikcraft {
    namespace io {
...
declare namespace magikcraft {
    namespace io {
         ...
         * ```
         */
        function exsultus(power: number): void;
    }
}
declare namespace magikcraft {
    namespace io {
         ...
         *
         */
        function getSender(): BukkitPlayer;
    }
}
...
declare namespace magikcraft {
    namespace io {
         ...
         * ```
         */
        function global(namespace: string): any;
    }
}
declare namespace magikcraft {
    namespace io {
...
declare namespace magikcraft {
    namespace io {
         ...
         * ```
         */
        function iacta(playername: string): void;
    }
}
declare namespace magikcraft {
    namespace io {
         ...
         * ```
         */
        function ianuae(location: BukkitLocation): void;
    }
}
declare namespace magikcraft {
    namespace io {
         ...
         * }
         */
        function incendium(playername: string): void;
    }
}
...
declare namespace magikcraft {
    namespace io {
        ...
        function memento(thing: any): void;
    }
}
